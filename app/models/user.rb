...
class User < ApplicationRecord
  ...
  has_many(:accepted_send_follow_requests, -> {status}, :class_name => "FollowRequest", :foreign_key => "sender_id")
  ...
  # has_many(:followers, :through => :accepted_received_follow_requests, :source => )
